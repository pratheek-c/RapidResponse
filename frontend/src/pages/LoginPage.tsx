                        ...
                        {DEPARTMENTS.map(({ id, label, description }) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`group flex flex-col gap-2 rounded-xl border p-3.5 text-left transition-colors ${selected
                                        ? "border-blue-500/70 bg-blue-500/10"
                                        : "border-slate-700/80 bg-slate-950/60 hover:border-slate-600 hover:bg-slate-900"
                                        }`}
                                >
                                    <div
                                        className={`flex h-8 w-8 items-center justify-center rounded-lg border ${selected
                                    ...
                                    <div>
                                        <p
                                            className={`text-sm font-semibold leading-tight ${selected ? "text-blue-100" : "text-slate-200"
                                                }`}
                                        >
                                            {label}
                                        </p>
